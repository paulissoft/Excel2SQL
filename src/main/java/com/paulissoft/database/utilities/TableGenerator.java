        ...
        if (dataRows.size() > 0) {
            ...
            for (Integer row : rows) {
                ...
                if (nrSeparatorsPrinted != table.getNrColumns() - 1) {
                    throw new RuntimeException("nrSeparatorsPrinted (" + nrSeparatorsPrinted + ") != " + "table.getNrColumns() - 1 (" + (table.getNrColumns() - 1) + ")");
                }
